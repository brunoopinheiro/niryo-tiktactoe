...
coordinates = ['j1','j2','j3','j4','j5','j6']

class CalibratedPositions:
    def __init__(self,center_board) -> None:
        #Number 5 on keyboard (center of the board and reference for other positions)
    ...
    def calibration(self):
        ...
        #Pose to get bead
        self.e1_pose_grip_base = self.e1_pose_board_center + {'j1': -1.552, 'j2': 0.321,
                                                            'j3': -0.517, 'j4': 0.133,
                                                            'j5': 0.468, 'j6': -0.112}
        
        #Pose above tray
        self.e1_pose_intermediate_tray = self.e1_pose_board_center + {'j1': -1.552, 'j2': 1.123,
                                                                    'j3': -0.352, 'j4': 0.133,
                                                                    'j5': -0.430, 'j6': -0.107}
        
        #Pose above board
        self.e1_pose_intermediate_board = self.e1_pose_board_center + {'j1': 0.025, 'j2': 1.123,
                                                                    'j3': -0.352, 'j4': 0.133,
                                                                    'j5': -0.430, 'j6': -0.117}
        
        #Pose closer to the board
        self.e1_pose_parallel_board = self.e1_pose_board_center + {'j1': 0.025, 'j2': 0.182,
                                                                    'j3': 0.150, 'j4': 0.0,
                                                                    'j5': -0.430, 'j6': -0.005}